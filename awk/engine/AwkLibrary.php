<?php
	...
	class AwkLibrary extends AwkModuleBase {
		...
		public function create() {
			...
			// Se for uma instância de `AwkBase`, armazena as informações da base.
			if($library_instance instanceof AwkBase) {
		...
		public function unique() {
			...
			if($reflection_instance->hasMethod("library_unique")) {
				...
				// Se for uma instância de `AwkBase`, armazena as informações da base.
				if($unique_instance instanceof AwkBase) {
			...
			// Se for uma instância de `AwkBase`, armazena as informações da base.
			if($this->unique_instance instanceof AwkBase) {
