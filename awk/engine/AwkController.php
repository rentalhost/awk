<?php
	...
	class AwkController extends AwkModuleBase {
		...
		public function load($controller_name) {
			...
			// Se o controller for uma instância de `AwkBase`, armazena as informações do módulo.
			if($this->instance instanceof AwkBase) {
